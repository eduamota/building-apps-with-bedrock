...
def handler(event, context):
    ...
    try:
        ...
        # Response is a StreamingBody in the 'response' key
        resp_body = response.get("response") or response.get("payload") or response.get("body")
        ...
        try:
            ...
            text = result.get("response", result.get("result", raw))
